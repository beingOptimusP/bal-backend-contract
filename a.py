...
contract_addy = "0xB595b850749b67172F99525b44E915DF6f779837"
...
tx = {
  ...
  "from": addy,
  "to": contract_addy,
  "data": contract.encodeABI(fn_name="add", args=["KA175",105]),
}
...
tx = {
  ...
  "from": addy,
  "to": contract_addy,
  "data": contract.encodeABI(fn_name="update", args=["KA375",111]),
}
